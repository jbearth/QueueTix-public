...
export interface IBlockProps
  ...
  white?: boolean;
  /**
   * Renders a backgroundColor directly from the colors.grey400 value
   * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
   */
  gray?: boolean;
  /**
...
export interface IButtonProps extends TouchableOpacityProps, ISpacing {
   ...
   */
  startAdornmentIcon?: boolean;
  endAdornmentIcon?: boolean;

  startIconUri?: any;
  startIconWidth?: string;
  startIconHeight?: string;
  startIconColors?: ColorValue;

  endIconUri?: any;
  endIconWidth?: any;
  endIconHeight?: any;
  endIconColors?: ColorValue;
  /**
   * Renders the View position
   * @see https://reactnative.dev/docs/layout-props#position
   */
...
export interface IInputProps extends TextInputProps, ISpacing {
  ...
  white?: boolean;
  /**
   * Renders a borderColor & placeholderTextColor directly from the colors.grey400 value
   * @see https://reactnative.dev/docs/view-style-props#backgroundcolor
   */
  gray?: boolean;
  /**
  ...
  Icon?: any;
  IconSize?: number;
  IconColors?: ColorValue;
  password?: boolean;
  formhelpers?: boolean;
  formhelperslabel?: string;
  modeSecureText?: boolean;
  /**
   ...
   */
  style?: TextStyle;
  inputContainnerStyle?: TextStyle;
  inputStyle?: TextStyle;
  radius?: number;
  sizeIconSerach?: number;
  inputBorder?: number;
}
...
export interface ITextProps extends TextProps, ISpacing {
  ...
  white?: boolean;
  /**
   * Renders a Text color directly from the colors.grey400 value
   * @see https://reactnative.dev/docs/text-style-props#color
   */
  gray?: boolean;
  /**
...
export interface IIconifyProps {
  ...
  IconHeight?: string;
  IconColors?: ColorValue
  IconColorDuotone?: ColorValue
  IconColorStroke?: ColorValue
}
