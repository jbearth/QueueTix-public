...
const Block = (props: IBlockProps) => {
  ...
  if (safe) {
    return (
      <SafeAreaView {...blockID} {...rest} style={[blockStyles, { marginTop: sizes.m }]}>
        {children}
      </SafeAreaView>
    );
  }
  ...
  if (scroll) {
    return (
      <ScrollView {...blockID} {...rest} style={blockStyles} showsVerticalScrollIndicator={hiddenScrollIndicator} refreshControl={refreshControl}>
        {children}
      </ScrollView>
    );
  }
